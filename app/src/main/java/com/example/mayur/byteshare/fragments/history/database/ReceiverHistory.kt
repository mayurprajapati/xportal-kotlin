...
class ReceiverHistory(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, 1) {
    ...
    fun insertData(filename: String, size: String, date: String): Boolean {
        val db = this.writableDatabase
    ...
    companion object {
        const val DATABASE_NAME = "receiverhistory.db"
